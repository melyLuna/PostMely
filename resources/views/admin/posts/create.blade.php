    ...
    <flux:main>
        ...
        <flux:card>
            <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <flux:textarea label="Resumen (Excerpt)" name="excerpt" :value="old('excerpt')" rows="2"
                    required />

                <flux:textarea label="Contenido del Post" name="content" rows="10" :value="old('content')"
                    required />
                ...
                <flux:select label="Etiquetas" name="tags[]"placeholder="Selecciona etiquetas" multiple>
                    @foreach ($tags as $tag)
